...
void KeyBindComponent::initAction()
{
	...
	m_configData[INPUT_TYPES::KEYBOARD]->m_buttonMap[BUTTON_IDS::UI_MOVE_FORWARD] = VK_UP;
	m_configData[INPUT_TYPES::KEYBOARD]->m_buttonMap[BUTTON_IDS::UI_MOVE_LEFT] = VK_LEFT;
	m_configData[INPUT_TYPES::KEYBOARD]->m_buttonMap[BUTTON_IDS::UI_MOVE_BACK] = VK_DOWN;
	m_configData[INPUT_TYPES::KEYBOARD]->m_buttonMap[BUTTON_IDS::UI_MOVE_RIGHT] = VK_RIGHT;
	m_configData[INPUT_TYPES::KEYBOARD]->m_buttonMap[BUTTON_IDS::BTN_OK] = VK_SPACE;
